...
urlpatterns = [
    ...
    path("api/v1/bod-eod/overview", StubView.as_view()),
    # Stub endpoints for agent pipeline (AutomationDashboard)
    path("api/v1/agent/status/", StubView.as_view()),
    path("api/v1/agent/status", StubView.as_view()),
    path("api/v1/agent/actions/", StubView.as_view()),
    path("api/v1/agent/actions", StubView.as_view()),
    path("api/v1/agent/notifications/", StubView.as_view()),
    path("api/v1/agent/notifications", StubView.as_view()),
    path("api/v1/agent/executions/", StubView.as_view()),
    path("api/v1/agent/executions", StubView.as_view()),
    path("api/v1/agent/toggle/", StubView.as_view()),
    path("api/v1/agent/toggle", StubView.as_view()),
    path("api/v1/agent/actions/<str:pk>/toggle/", StubView.as_view()),
    path("api/v1/agent/actions/<str:pk>/toggle", StubView.as_view()),
    path("api/v1/agent/notifications/<str:pk>/toggle/", StubView.as_view()),
    path("api/v1/agent/notifications/<str:pk>/toggle", StubView.as_view()),
]
