...
urlpatterns = [
    ...
    path("<uuid:pk>/changes/<uuid:link_id>/", views.IncidentChangeUnlinkView.as_view(), name="incident-unlink-change"),
    path("<uuid:pk>/problems/", views.IncidentProblemLinkView.as_view(), name="incident-link-problem"),
    path("<uuid:pk>/problems/<uuid:link_id>/", views.IncidentProblemUnlinkView.as_view(), name="incident-unlink-problem"),
